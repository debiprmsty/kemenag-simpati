  ...
  <div class="w-full flex flex-col justify-center md:max-w-[94vw] max-w-[92vw] mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-lg p-4 md:p-6 space-y-6 mb-16 md:mb-72">
      ...
      <div class="overflow-x-auto">
        <table class="min-w-[600px] w-full bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            >
              <!-- Kolom “No”: hitung secara dinamis -->
      ...
      <div class="flex justify-center items-center space-x-4 mt-4">
        ...
        <span class="text-gray-700 text-sm">{{ currentPage }} dari {{ totalPages }}</span>
        <button
          @click="nextPage"
...
onMounted(async () => {
  try {
    ...
    // 3) Sort dari yang terbaru ke terlama berdasarkan timestamp
    detailed.sort((a, b) => new Date(b.timestamp) - new Date(a.timestamp));

    // 4) Simpan hasil yang sudah terurut
...
// **Catatan:** Karena `requests.value` sudah terurut,
// maka `filteredItems` dan `paginatedItems` otomatis mengikuti urutan ini.
...
const filteredItems = computed(() =>
  // apply filter SEARCH + FILTER_LAYANAN, tetap mempertahankan urutan aslinya
