        ...
        <div class="px-6 py-4">
          ...
          <form @submit.prevent="handleLogin">
            ...
            <div class="flex items-center justify-between mt-4 mb-2">
              ...
              <button
                type="submit"
                class="px-6 py-2 hover:cursor-pointer text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-800 rounded-lg hover:bg-green-700 focus:outline-none focus:ring focus:ring-green-300 focus:ring-opacity-50"
              >
                Masuk
              </button>
            </div>
